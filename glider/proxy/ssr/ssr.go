...
import (
	...
	"CheckProxy/glider/pkg/socks"
	"CheckProxy/glider/proxy"

	"CheckProxy/glider/proxy/ssr/internal"
	"CheckProxy/glider/proxy/ssr/internal/cipher"
	"CheckProxy/glider/proxy/ssr/internal/obfs"
	"CheckProxy/glider/proxy/ssr/internal/protocol"
	ssrinfo "CheckProxy/glider/proxy/ssr/internal/ssr"
)
